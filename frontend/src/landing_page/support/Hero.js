            ...
            <div className="row p-5">
                <div className="col-md-6 col-12 mt-2">
                    ...
                    <div className="help-links">
                        <a href="" className="help-link">Track account opening</a>
                        <a href="" className="help-link">Track segment activation</a>
                        <a href="" className="help-link">Intraday</a>
                        <a href="" className="help-link">margins</a>
                        <a href="" className="help-link">Kite user manual</a>
                    </div>
                </div>
